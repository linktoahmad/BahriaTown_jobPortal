        ...
        >
          ...
          >
            <Typography variant="h5" style={{ paddingBottom: "15px" }}>
              Edit interview Date and Medium
            </Typography>
    ...
    <Paper className={classes.jobTileOuter} elevation={3}>
      <Grid container>
        ...
        <Grid container item xs={7} spacing={1} direction="column">
          ...
          <Grid item>Address: {application.jobApplicant.email}</Grid>
...
const JobApplications = (props) => {
  ...
  const getData = () => {
    ...
    let address = `${apiList.applicants}?status=${"shortlisted"}`; // remove job id from here and from the api
    if (queryString !== "") {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography variant="h2">Scheduled Interviews</Typography>
        </Grid>
        <Grid item>
          <Typography variant="h6">
            Interviews to held - {applications.length}
          </Typography>
        </Grid>
        <Grid item>
